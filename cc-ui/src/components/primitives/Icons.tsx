...
import {
  ...
  MousePointer2, MousePointerClick, MessageSquare, MessageSquareCode, MoveUpRight, Save, Eraser, Undo2, RefreshCw, Compass, SquareTerminal, SlidersHorizontal, Bot, ArrowDownFromLine, ArrowUpFromLine, Tag, Layers, Brain,
  type LucideProps,
} from 'lucide-react'
...
export function ISpinner({ size = 20, spin = true, style: extraStyle }: { size?: number; spin?: boolean; style?: React.CSSProperties }) {
  return (
    <svg
      ...
      className={spin ? 'logo-spin' : undefined}
      style={{ width: size, height: size, display: 'block', overflow: 'visible', flexShrink: 0, color: 'var(--accent)', ...extraStyle }}
    >
      <g transform="matrix(40.987701,0,0,47.017293,-1066.181752,-723.213702)"><path d="M73,19.923L73,34.077C73,36.242 70.984,38 68.5,38C66.016,38 64,36.242 64,34.077L64,19.923C64,17.758 66.016,16 68.5,16C70.984,16 73,17.758 73,19.923Z" fill="currentColor" className={spin ? 'logo-pulse' : undefined} style={spin ? { animationDelay: '0s' } : undefined} /></g>
      <g transform="matrix(29.580315,28.930009,-31.91902,33.931797,1407.038703,-1975.472569)"><path d="M73,19.923L73,34.077C73,36.242 70.984,38 68.5,38C66.016,38 64,36.242 64,34.077L64,19.923C64,17.758 66.016,16 68.5,16C70.984,16 73,17.758 73,19.923Z" fill="currentColor" className={spin ? 'logo-pulse' : undefined} style={spin ? { animationDelay: '-0.6s' } : undefined} /></g>
      <g transform="matrix(29.238983,29.28855,-31.868474,33.077201,819.147115,-352.119241)"><path d="M73,19.923L73,34.077C73,36.242 70.984,38 68.5,38C66.016,38 64,36.242 64,34.077L64,19.923C64,17.758 66.016,16 68.5,16C70.984,16 73,17.758 73,19.923Z" fill="currentColor" className={spin ? 'logo-pulse' : undefined} style={spin ? { animationDelay: '-2.4s' } : undefined} /></g>
      <g transform="matrix(-40.986978,0.248248,-0.232396,-39.892632,4554.901946,4098.265856)"><path d="M73,19.923L73,34.077C73,36.242 70.984,38 68.5,38C66.016,38 64,36.242 64,34.077L64,19.923C64,17.758 66.016,16 68.5,16C70.984,16 73,17.758 73,19.923Z" fill="currentColor" className={spin ? 'logo-pulse' : undefined} style={spin ? { animationDelay: '-3s' } : undefined} /></g>
      <g transform="matrix(-27.307354,-31.16698,34.160049,-31.117626,1985.168069,4522.127633)"><path d="M73,19.923L73,34.077C73,36.242 70.984,38 68.5,38C66.016,38 64,36.242 64,34.077L64,19.923C64,17.758 66.016,16 68.5,16C70.984,16 73,17.758 73,19.923Z" fill="currentColor" className={spin ? 'logo-pulse' : undefined} style={spin ? { animationDelay: '-4.8s' } : undefined} /></g>
      <g transform="matrix(-29.582967,-33.764229,13.546438,-12.339941,2363.40733,3358.078607)"><path d="M73,19.923L73,34.077C73,36.242 70.984,38 68.5,38C66.016,38 64,36.242 64,34.077L64,19.923C64,17.758 66.016,16 68.5,16C70.984,16 73,17.758 73,19.923Z" fill="currentColor" className={spin ? 'logo-pulse' : undefined} style={spin ? { animationDelay: '-5.4s' } : undefined} /></g>
      <g transform="matrix(-29.582967,-33.764229,13.546438,-12.339941,3408.593705,4455.148787)"><path d="M73,19.923L73,34.077C73,36.242 70.984,38 68.5,38C66.016,38 64,36.242 64,34.077L64,19.923C64,17.758 66.016,16 68.5,16C70.984,16 73,17.758 73,19.923Z" fill="currentColor" /></g>
      <g transform="matrix(-29.582967,-33.764229,13.546438,-12.339941,4423.039305,5458.184379)"><path d="M73,19.923L73,34.077C73,36.242 70.984,38 68.5,38C66.016,38 64,36.242 64,34.077L64,19.923C64,17.758 66.016,16 68.5,16C70.984,16 73,17.758 73,19.923Z" fill="currentColor" className={spin ? 'logo-pulse' : undefined} style={spin ? { animationDelay: '-1.8s' } : undefined} /></g>
      <g transform="matrix(-28.982321,-29.552586,32.605921,-33.245834,2047.144742,5568.348688)"><path d="M73,19.923L73,34.077C73,36.242 70.984,38 68.5,38C66.016,38 64,36.242 64,34.077L64,19.923C64,17.758 66.016,16 68.5,16C70.984,16 73,17.758 73,19.923Z" fill="currentColor" className={spin ? 'logo-pulse' : undefined} style={spin ? { animationDelay: '-3.6s' } : undefined} /></g>
      <g transform="matrix(0.231081,-41.792485,46.110431,0.265075,1710.296113,4624.331086)"><path d="M73,19.923L73,34.077C73,36.242 70.984,38 68.5,38C66.016,38 64,36.242 64,34.077L64,19.923C64,17.758 66.016,16 68.5,16C70.984,16 73,17.758 73,19.923Z" fill="currentColor" className={spin ? 'logo-pulse' : undefined} style={spin ? { animationDelay: '-1.2s' } : undefined} /></g>
      <g transform="matrix(-0.543775,-41.789472,43.312489,-0.585961,-625.339269,4646.686721)"><path d="M73,19.923L73,34.077C73,36.242 70.984,38 68.5,38C66.016,38 64,36.242 64,34.077L64,19.923C64,17.758 66.016,16 68.5,16C70.984,16 73,17.758 73,19.923Z" fill="currentColor" className={spin ? 'logo-pulse' : undefined} style={spin ? { animationDelay: '-4.2s' } : undefined} /></g>
    </svg>
  )
}
