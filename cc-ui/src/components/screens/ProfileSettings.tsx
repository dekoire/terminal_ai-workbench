    ...
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', background: 'var(--bg-0)', minHeight: 0, overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, display: 'flex', minHeight: 0 }}>
        ...
        <aside style={{
          ...
          <div
            onClick={() => { setActiveStorageUser(''); localStorage.removeItem('cc-user-id'); localStorage.removeItem('cc-active-session'); sessionStorage.removeItem('cc-active-session'); setCurrentUser(null); setScreen('login'); useAppStore.getState().resetUserData() }}
            style={{
